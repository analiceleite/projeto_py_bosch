...
def solicitar_confirmacao_midia(midia_em_cadastro):
    print("Título:",midia_em_cadastro.get_titulo(),"\nCategoria:",midia_em_cadastro.get_categoria(),"\nAutoria:",midia_em_cadastro.get_autoria(),"\nAno lançamento:",midia_em_cadastro.get_ano_lancamento(),"\nClassificação indicativa:",midia_em_cadastro.get_classificacao_indicativa(),"+\nIdioma:",midia_em_cadastro.get_idioma()+"\nTiragem:",midia_em_cadastro.get_tiragem(),"\nAvaliação:",midia_em_cadastro.get_avaliacao_geral())
    return bool_menu_confirmacao()
